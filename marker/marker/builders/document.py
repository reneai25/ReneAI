...
class DocumentBuilder(BaseBuilder):
    """
    Constructs a Document given a PdfProvider, YOLOBuilder, and OcrBuilder.
    """
    ...
    def __call__(self, provider: PdfProvider, layout_builder: YOLOBuilder, line_builder: LineBuilder, ocr_builder: OcrBuilder):
